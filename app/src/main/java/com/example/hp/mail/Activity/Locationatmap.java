...
public class Locationatmap extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_locationatmap);
                ...
                try {
                    ...
                    if(!addresses.isEmpty()) {
                        if (geocoder.isPresent()) {
                            ...
                            } else if (locality.equals(featurename)) {
                            } else {
                                str.append(locality + " ");
                            }
                            if (area.equals(null)) {
                    ...
                    }else{ Toast.makeText(getApplicationContext(),"Address not obtained for particular coordinates",Toast.LENGTH_SHORT).show();
                    }
                } catch (IOException e) {
