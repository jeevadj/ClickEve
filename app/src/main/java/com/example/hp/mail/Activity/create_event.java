...
public class create_event extends Fragment implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener{
    ...
    TextView starttime, startdate, enddate, endtime, en,des,noimageselected;
    public static TextView loc;
    Spinner spinner;
    RecyclerView recyclerView1;
    FloatingActionButton fab1, fab2;
    String sdate, edate;
    Button setevent,selectimage;
...
//        imageView=(CircleImageView)view.findViewById(R.id.eventimage);
        ...
        selectimage = (Button)view.findViewById(R.id.select_image_button);
           // selectimageLayout = (LinearLayout)view.findViewById(R.id.filename_layout);
        en=(TextView)view.findViewById(R.id.event);
        des=(TextView)view.findViewById(R.id.description);
        noimageselected = (TextView)view.findViewById(R.id.no_image_selected);
...
//            snackbar.show();
    ...
    public class MyTask extends AsyncTask<String, Integer,String>{
        ...
        protected String doInBackground(String... params) {
            ...
            event.setLatitude(DT.lat);
            event.setLongitude(DT.lng);
